...
applications.
 ...
 problems historyically faced by LPWA schemes. By using a laser so powerful it
 completely expells electrons from a region, the bubble regime was predicted to
...
accelerated. This process is refered to as self-injection. \sidenote{Although self-injection happens in
